...
export default function Contact() {
  const emailHref =
    "mailto:erdmannvisuals@outlook.com?subject=Video%20Project%20Inquiry&body=Hello%20Michael,%0D%0A%0D%0AI%20would%20like%20to%20discuss%20a%20project.%20Here%20are%20some%20details:%0D%0A-%20Type%20of%20project:%0D%0A-%20Timeline:%0D%0A-%20Budget%20range:%0D%0A%0D%0ALooking%20forward%20to%20hearing%20from%20you.%0D%0A%0D%0ARegards,";

  const whatsappHref =
    "https://wa.me/32470477419?text=Hello%20Michael,%20I%20am%20interested%20in%20your%20video%20services.%20I%20would%20like%20to%20discuss%20a%20project.";

  return (
    <section id="contact" className="mx-auto max-w-7xl px-5 py-16">
      <Reveal y={40} amount={0.35}>
        <div className="rounded-3xl border border-white/10 bg-white/5 p-12 md:p-20 text-center">
